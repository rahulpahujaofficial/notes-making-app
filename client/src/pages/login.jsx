  ...
  return (
    <div className='flex justify-center items-center min-h-screen bg-linear-to-t from-pink-400 to-indigo-500'>
        <div className='bg-white rounded-2xl p-[30px]'>
            ...
            <div className='flex'>
                <div className='text-[13px]'>Login an account or</div>
                <button className='text-[13px] pl-1 text-pink-500 hover:underline cursor-pointer' onClick={navigateSignupPage}>Signup</button>
            </div>
